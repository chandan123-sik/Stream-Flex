      ...
      <div className="relative z-10 w-full max-w-md mx-auto px-4 sm:px-6">
        ...
        <div className="bg-black/80 backdrop-blur-sm rounded-xl p-6 sm:p-8 lg:p-10 border border-white/10">
          <form onSubmit={handleSubmit}>
            <h1 className="text-xl sm:text-2xl font-bold text-white text-center mb-6 sm:mb-8">Sign In</h1>
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 sm:mb-8 text-xs sm:text-sm gap-3 sm:gap-0">
              <label className="flex items-center gap-2 text-text-secondary cursor-pointer">
                <input type="checkbox" className="w-3 h-3 sm:w-4 sm:h-4 accent-accent-red" />
                Remember me
              </label>
              <Link to="/forgot-password" className="text-white hover:text-accent-red transition-colors duration-300">
                Forgot password?
              </Link>
            </div>
            ...
            <div className="text-center mb-4 sm:mb-5 relative">
              ...
              <span className="bg-black/80 px-4 sm:px-5 text-text-secondary text-xs sm:text-sm">New to StreamFlix?</span>
            </div>

            <Link to="/register" className="block w-full text-center py-3 sm:py-4 bg-transparent border border-border-color text-white rounded-md font-semibold transition-all duration-300 hover:bg-white/10 hover:border-white text-sm sm:text-base">
              Sign up now
            </Link>

            <div className="mt-6 sm:mt-8 p-3 sm:p-4 bg-white/5 rounded-md border border-white/10 text-center text-xs text-text-secondary">
              <p className="text-white font-semibold mb-2">Demo Credentials:</p>
              <p>Email: demo@streamflix.com</p>
